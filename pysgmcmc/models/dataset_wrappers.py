...
class WineQualityRed(object):
    @classmethod
    def load_data(cls, path=abspath(path_join(__file__, "../../../datasets/winequality-red.csv")),
...
class YachtHydrodynamics(object):
    @classmethod
    def load_data(cls, path=abspath(path_join(__file__, "../../../datasets/yacht-hydrodynamics.csv")),
                  test_split=0.2, seed=113):
        data_frame = pandas.read_csv(path, delimiter=";")
...
class Concrete(object):
    @classmethod
    def load_data(cls, path=abspath(path_join(__file__, "../../../datasets/concrete.xls")), test_split=0.2, seed=113):
